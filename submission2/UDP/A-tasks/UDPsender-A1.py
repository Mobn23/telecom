...
payload = 'M' * 1462 #Payload: 1500−28=1472-5(10001)-4("####")-1(;) = 1462 bytes (maximum payload size). Using 1452 bytes leaves a small buffer for safety.  1 byte (8 bits) = 1 character in ASCII encoding.
termination = "####"
