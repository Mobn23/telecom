...
payload = 'M' * 1465 #Payload: 1500−28=1472 bytes (maximum payload size). Using 1465 bytes leaves a small buffer for safety.  1 byte (8 bits) = 1 character in ASCII encoding.
termination = "####"
