...
payload = 'M' * 1452 #Payload: 1500−28=1472-5(10001)-4("####")-1(;) = 1462 bytes (maximum payload size). Using 1452 bytes leaves a small buffer for safety.  1 byte (8 bits) = 1 character in ASCII encoding.
termination = "####"

duration_seconds = 30
f = 50 # 50 packets/second
...
try:
    while time.time() < end_time:
        ...
        sequence_number += 1
        time.sleep(1.0/f)# 50 packets/second
